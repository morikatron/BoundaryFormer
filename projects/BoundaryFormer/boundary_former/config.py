...
def add_boundaryformer_config(cfg):
    ...
    cfg.MODEL.BOUNDARY_HEAD.IS_DECODER_RESIDUAL = False
    cfg.MODEL.BOUNDARY_HEAD.DETACH_EACH_LEVEL = False
    cfg.MODEL.BOUNDARY_HEAD.NUM_LAYER_PER_LEVEL = 1
    cfg.MODEL.BOUNDARY_HEAD.GAN_LOSS = 0
    ...
    cfg.MODEL.DIFFRAS.DICE_LOSS_WEIGHT_FP = 1
    cfg.MODEL.DIFFRAS.DICE_LOSS_WEIGHT_FN = 1
    cfg.MODEL.DIFFRAS.POLY_SMOOTH_LOSS_WEIGHT_TYPE = ''
    cfg.MODEL.DIFFRAS.POLY_SMOOTH_LOSS_WEIGHT_POINTWISE = []
