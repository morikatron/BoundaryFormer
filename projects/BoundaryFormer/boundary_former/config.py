...
def add_boundaryformer_config(cfg):
    ...
    cfg.MODEL.BOUNDARY_HEAD.GAN_LOSS = 0.0
    cfg.MODEL.BOUNDARY_HEAD.ADDITIONAL_LEVEL = False
    cfg.MODEL.BOUNDARY_HEAD.DETACH_ADDITIONAL_LEVEL = False
    cfg.MODEL.BOUNDARY_HEAD.GAN = CN()
    cfg.MODEL.BOUNDARY_HEAD.GAN.G_LOSS_WEIGHT = 1.0
    cfg.MODEL.BOUNDARY_HEAD.GAN.D_LOSS_WEIGHT = 1.0
    cfg.MODEL.BOUNDARY_HEAD.GAN.MODEL_DIM = 64
    cfg.MODEL.BOUNDARY_HEAD.GAN.NUM_LAYERS = 3
    ...
    cfg.MODEL.DIFFRAS.DICE_LOSS_WEIGHT_FP = 1.0
    cfg.MODEL.DIFFRAS.DICE_LOSS_WEIGHT_FN = 1.0
